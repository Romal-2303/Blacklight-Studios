...
const Mobile: React.FC<MobileProps> = ({ fill = "#333333" }) => {
  return (
    <svg
      version="1.1"
      id="MOBILE"
    ...
    >
      <g>
        <path
          fill={fill}
          d="M1346.861,3.943h-893.72c-45.89,0-83.232,37.339-83.232,83.229v1625.653
        ...
        <path
          fill={fill}
          d="M949.946,143.519h-43.739h-12.412h-43.74c-8.655,0-15.667,7.012-15.667,15.667
        ...
        <path
          fill={fill}
          d="M900.002,1538.701c-39.779,0-72.144,32.355-72.144,72.135c0,39.778,32.365,72.145,72.144,72.145
